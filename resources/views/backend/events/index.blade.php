            ...
            <div class="card">
                <div class="card-header card-info">
                    ...
                    <div class="card-btn pull-right">
                        <a href="{{route('events.create')}}" title="Add new event" class="btn btn-primary btn-sm pull-right"> <i class="fa fa-plus-circle"></i> Add new </a>
                    </div>
                </div>
                @if(count($faqs)>0)
                    <div class="card-body">
                        <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                            ...
                            @foreach($faqs as $faq)
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::open(array('route' => ['events.destroy',$faq->id],'method'=>'DELETE','id'=>"deleteForm$faq->id")) !!}
                                        <a href="{{route('events.edit',$faq->id)}}" class="btn btn-xs btn-info"> <i class="fa fa-edit"></i> </a>

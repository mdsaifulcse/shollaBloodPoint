    ...
    <div class="row ">
        <div class="col-lg-12">
            <div class="card ">
                ...
                {!! Form::open(array('route' =>'faq.store','method'=>'POST','class'=>'form-horizontals','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            ...
                            <div class="">
                                {{Form::number('serial_num',$value=$maxNum+1,['max'=>$maxNum,'class'=>'form-control','required'=>true])}}
                            </div>
                            <span class="text-danger">
                                    {{$errors->has('status')?$errors->first('status'):''}}
                                </span>

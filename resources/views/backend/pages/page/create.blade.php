    ...
    <div class="row ">
        <div class="col-lg-12">
            <div class="card ">
                ...
                {!! Form::open(array('route' =>'pages.store','method'=>'POST','class'=>'form-horizontals','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="">
                                {{Form::textarea('short_description',$value=old('short_description'),['class'=>'form-control tinymce','placeholder'=>'Very Short Description, within 130 character','required'=>false,'rows'=>1])}}
                                <span class="text-danger">

            ...
            <div class="card">
                <div class="card-header card-info">
                    ...
                    <div class="card-btn pull-right">
                        <a href="{{route('frontend-menu.index')}}" class="btn btn-primary pull-right"> <i class="fa fa-list"></i> View All </a>
                    </div>
                </div>

                {!! Form::open(array('route' => ['frontend-menu.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)) !!}
                <div class="card-body">
                    ...
                    {{--<div class="form-group row">--}}
                        ...
                        {{--<div class="col-md-8">--}}
                            {{--{{Form::select('slug[]', $data->slug,[], ['class' => 'form-control select','multiple','required'])}}--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            {{Form::select('type', array( '2' => 'Menu'),$data->type, ['class' => 'form-control'])}}
                        </div>

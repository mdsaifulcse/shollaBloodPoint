            ...
            <div class="card">
                <div class="card-header card-info ">
                    ...
                    <div class="card-btn pull-right">
                        <a href="{{route('frontend-menu.index')}}" class="btn btn-primary btn-sm"> <i class="fa fa-list"></i>All Module</a>
                    </div>
                </div>

                <div class="card-body">
                    <div class="menu_form left">
                        {!! Form::open(array('route' => 'frontend-sub-menu.store','class'=>'form-horizontal','files'=>true)) !!}
                    ...
                    <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                        ...
                        @foreach($allData as $data)
                            <tr>
                                ...
                                <td><a href="{{route('frontend-menu.edit',$data->menu_id)}}" class="label label-primary" style="color: #fff;">{{$data->menu_name}}</a></td>
                                @if(!isset($subMenu))
                                    ...
                                    <div class="modal fade" id="editModal{{$data->id}}" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                {!! Form::open(array('route' => ['frontend-sub-menu.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)) !!}
                                                <br>
                                                <div class="form-group row   {{ $errors->has('name') ? 'has-error' : '' }}">
                                                    {{Form::label('name', ' Name', array('class' => 'col-md-3 control-label'))}}
                                                    <div class="col-md-8">
                        ...
                        <strong>{{ $errors->first('url') }}</strong>
                                    ...
                                    {!! Form::open(array('route' => ['frontend-sub-menu.destroy',$data->id],'method'=>'DELETE','class'=>'deleteForm','id'=>"deleteForm$data->id")) !!}

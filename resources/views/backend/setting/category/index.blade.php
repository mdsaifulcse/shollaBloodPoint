                        ...
                        <div class="modal fade" id="modal-dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    {!! Form::open(array('route' => 'category.store','class'=>'form-horizontal','method'=>'POST','files'=>true)) !!}
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                {{Form::text('category',$value=old('category'),['class'=>'form-control','placeholder'=>' category name','required'=>true])}}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                {{Form::file('category_img',['id'=>'category_img','class'=>'form-control','accept'=>'image/*'])}}
                                            </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                @foreach($categories as $category)
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{$category->url}}</td>
                                        <td>@if($category->category_img)
                                                <img src="{{asset($category->category_img)}}" width="50" height="50">
                                            @else
                                                <span class="text-danger">No Category Image</span>
                                            @endif</td>
                                        <td class="text-dark">
                                        ...
                                        <td>
                                            <!-- edit section -->
                                            <a href="#modal-dialog<?php echo $category->id;?>" class="btn btn-xs btn-primary" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            <!-- #modal-dialog -->

                                            <div class="modal fade" id="modal-dialog<?php echo $category->id;?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        {!! Form::open(array('route' => ['category.update',$category->id],'class'=>'form-horizontal','method'=>'PUT','files'=>true)) !!}
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Edit old category info</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="control-label col-md-3 col-sm-3"> Name <sup class="text-danger">*</sup> :</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    {{Form::text('category',$value=$category->category,['class'=>'form-control','placeholder'=>'category name','required'=>true])}}
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="control-label col-md-3 col-sm-3"> Url <sup class="text-danger">*</sup> :</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    {{Form::text('url',$value=$category->url,['class'=>'form-control','placeholder'=>'url','required'=>true,'readonly'=>true,])}}
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="control-label col-md-3 col-sm-3"> Serial <sup class="text-danger">*</sup> :</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    {{Form::number('serial_num',$value=$category->serial_num,['class'=>'form-control','min'=>1,'required'=>true])}}
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="control-label col-md-3 col-sm-3"> Icon <sup class="text-danger">*</sup> :</label>
                                            ...
                                            <!-- delete section -->
                                            {{Form::open(array('route'=>['category.destroy',$category->id],'method'=>'DELETE','class'=>'deleteForm','id'=>"deleteForm$category->id"))}}
...
@section('script')
    <script>
        function loadCategoryImg(input,image_load) {

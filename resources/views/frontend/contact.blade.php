                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <div class="gradient-wrapper mb--xs">
                        <div class="gradient-title">
                            <h2>Contact With us ({{$primaryInfo->company_name}})</h2>
                        </div>
                        <div class="contact-layout1 gradient-padding">
                            ...
                            {!! Form::open(['url'=>'user-message','method'=>'POST','class'=>'']) !!}
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group  has-danger">
                                                {{Form::email('email',$value=old('email'),['class'=>'form-control','placeholder'=>'Your email','required'=>true])}}
                                                <span class="text-danger">{{$errors->has('email')?$errors->first('email'):''}}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group  has-danger">
                                                {{Form::number('mobile',$value=old('mobile'),['class'=>'form-control','min'=>0,'placeholder'=>'Your Mobile','required'=>true])}}
                                                <span class="text-danger">{{$errors->has('mobile')?$errors->first('mobile'):''}}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group has-danger">
                                                {{Form::text('subject',$value=old('subject'),['class'=>'form-control','placeholder'=>'Subject','required'=>true])}}
                                                <span class="text-danger">{{$errors->has('subject')?$errors->first('subject'):''}}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group  has-info">
                                                {{Form::textarea('message',$value=old('message'),['class'=>'form-control','placeholder'=>'Your Message','required'=>true])}}

                                ...
                                <div class="login-form">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 col-mb-12">
                                            {!! Form::open(['url'=>'edit-profile','method'=>'POST','class'=>'donor-register','files'=>true]) !!}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::text('name',$value=$memberInfo->userData->name,['class'=>'form-control','placeholder'=>'Your name','required'=>true])}}
                                                        {{Form::hidden('id',$value=$memberInfo->id)}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group" >
                                                        {{Form::select('gender',['Male'=>'Male','Female'=>'Female'],$memberInfo->gender,['class'=>'form-control','placeholder'=>'-- Please select Gender--','required'=>true])}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::text('father_name',$value=$memberInfo->father_name,['class'=>'form-control','placeholder'=>'Your father name','required'=>true])}}
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::select('district_id',$districts,$memberInfo->district_id,['id'=>'loadThana','class'=>'form-control','placeholder'=>'-- Select District --','required'=>true])}}
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group" >
                                                        <div id="thanaUpazila">
                                                            {{Form::select('thana_upazila_id',$thans,$memberInfo->thana_upazila_id,['class'=>'form-control','placeholder'=>'--First Select District --','required'=>true])}}
                                                        </div>
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-university" aria-hidden="true"></i>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        <div id="UnionInfo">
                                                            {{Form::select('union_id',$unions,$memberInfo->union_id,['id'=>'loadVillage','class'=>'form-control','placeholder'=>'-- Select Thana First --','required'=>true])}}
                                                        </div>
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        <div id="villageInfo">
                                                            {{Form::select('village_id',$villages,$memberInfo->village_id,['class'=>'form-control','placeholder'=>'-- Select Union First --','required'=>true])}}
                                                        </div>
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group" >
                                                        {{Form::select('blood_group_id',$bloodGroups,$memberInfo->blood_group_id,['class'=>'form-control','placeholder'=>'-- Please Blood Group --','required'=>true])}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::text('birthdate',$value=date('d-m-Y',strtotime($memberInfo->birthdate)),['autocomplete'=>'off','class'=>'form-control datepicker','required'=>true])}}
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-calendar" aria-hidden="true"></i>
                                                        </div>
                                                    </div>
                                                    <span class="text-danger">{{$errors->has('firthdate')?$errors->first('firthdate'):''}}</span>
                                                </div>
                                            </div><!--end row-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::text('facebook_id',$value=$memberInfo->facebook_id,['class'=>'form-control','placeholder'=>'Your facebook id','required'=>false])}}
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-facebook" aria-hidden="true"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::number('phone_number',$value=$memberInfo->userData->phone_number,['class'=>'form-control','min'=>0,'required'=>true,'placeholder'=>'Your phone_number number (you can use for login)','required'=>true])}}
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group">
                                                        {{Form::email('email',$value=$memberInfo->userData->email,['class'=>'form-control','placeholder'=>'Your email (you can use for login','required'=>true])}}
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                                    <div class="input-group" >
                                                        {{Form::select('member_type',['1'=>'Blood Donor','2'=>'I want to be a voluntary member'],$memberInfo->member_type,['id'=>'memberType','class'=>'form-control','placeholder'=>'-- Please select --','required'=>true])}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-7 col-xs-12">
                                                    ...
                                                    @if(file_exists($memberInfo->photo))
                                                    <label class="slide_upload"  for="memgerPhoto" >
                                                        <img id="selectedImg" src="{{asset($memberInfo->photo)}}" style="border: 2px dashed #448aff;width: 120px;height: 120px" title="Member Photo">
                                                    </label>
                                                    @else
                                                        <label class="slide_upload"  for="memgerPhoto" >

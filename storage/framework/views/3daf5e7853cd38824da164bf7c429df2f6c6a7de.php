...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(URL::to('pages')); ?>">Page</a>
        </li>
    </ul>
    ...
    <div class="row ">
        <div class="col-lg-12">
            <div class="card ">
                ...
                <?php echo Form::open(array('route' =>['pages.update',$page->id],'method'=>'PUT','class'=>'form-horizontals','files'=>true)); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <?php echo e(Form::text('title',$value=$page->title,['class'=>'form-control','required'=>true])); ?>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            <label>Status</label>
                            <div class="">
                                <?php echo e(Form::select('status',['1'=>'Active','0'=>'Inactive'],$page->status,['class'=>'form-control','required'=>true])); ?>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            ...
                            <div class="">
                                <?php echo e(Form::number('serial_num',$value=$page->serial_num,['min'=>1,'class'=>'form-control','required'=>true])); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="">
                                <?php echo e(Form::textarea('short_description',$value=$page->short_description,['class'=>'form-control tinymce','placeholder'=>'Very Short Description, within 130 character','required'=>false,'rows'=>1])); ?>
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <label>Details</label>
                            <div class="">
                                <?php echo e(Form::textarea('details',$value=$page->details,['class'=>'form-control tinymce','placeholder'=>'Details about our page','required'=>false,'rows'=>8])); ?>
                        ...
                        <div class="">
                            <?php if(!empty($page)): ?>
                                <label class="slide_upload"  for="pageImage">
                                    <img id="selectedImg" src="<?php echo e(asset($page->photo)); ?>" width="150" height="120" title="Page Image">
                                </label>
                                <?php else: ?>
                                <label class="slide_upload"  for="pageImage">

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo Form::open(array('route' =>['gallery.update',$photoGallery->id],'class'=>'form-horizontal','method'=>'PUT')); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::text('title',$value=$photoGallery->title,['class'=>'form-control','placeholder'=>'Event Title','required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::text('event_date',$value=date('d-m-Y',strtotime($photoGallery->event_date)),['class'=>'form-control datepicker','min'=>0,'required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::text('photo_link',$value=$photoGallery->photo_link,['class'=>'form-control','placeholder'=>'Google Drive Link','required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::select('status',['1'=>'Active','0'=>'Inactive'],$photoGallery->status,['class'=>'form-control','required'=>true])); ?>

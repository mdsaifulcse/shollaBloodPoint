            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-info">
                        ...
                        <h4 class="card-title">Edit Founder Members</h4>
                    </div>
                    <div class="card-body">
                        <?php echo Form::open(array('route' => ['founder-members.update',$fmember->id],'class'=>'form-horizontal','method'=>'PUT','files'=>true)); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::text('name',$value=$fmember->name,['class'=>'form-control','placeholder'=>'Enter Founder Member Name','required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::text('designation',$value=$fmember->designation,['class'=>'form-control','min'=>0,'required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::select('blood_group_id',$bloodGroups,$fmember->blood_group_id,['class'=>'form-control','placeholder'=>'Select Blood Group','required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <?php echo e(Form::select('status',['1'=>'Active','0'=>'Inactive'],$fmember->status,['class'=>'form-control','required'=>true])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <?php if($fmember->photo): ?>
                                <label class="photo"  for="pageImage" style="border: 2px dashed #448aff">
                                    <img id="selectedImg" src="<?php echo e(asset($fmember->photo)); ?>" width="150" height="120" title="Page Image">
                                </label>
                                <?php else: ?>
                                    <label class="photo"  for="pageImage" style="border: 2px dashed #448aff">

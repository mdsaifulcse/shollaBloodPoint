                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="text" class="form-control <?php echo e($errors->has('email') || $errors->has('phone_number') ? ' is-invalid' : ''); ?>" name="phone_number" value="<?php echo e(old('phone_number')); ?>" required autofocus>

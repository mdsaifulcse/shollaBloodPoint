...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(URL::to('notice')); ?>">Notices</a>
        </li>
    </ul>
            ...
            <div class="card ">
                <div class="card-header card-info">
                    ...
                    <div class="card-btn pull-right">
                        <a href="<?php echo e(URL::to('notice')); ?>" title="View All Notices" class="btn btn-primary btn-sm" > <i class="fa fa-list"></i> All Notices</a>
                    </div>
                </div>

                <?php echo Form::open(array('route' =>'notice.store','method'=>'POST','class'=>'form-horizontals','files'=>true)); ?>

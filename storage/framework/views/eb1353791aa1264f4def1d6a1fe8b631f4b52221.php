                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                <?php $__currentLoopData = $thanaUpazilas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thanaUpazila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td> <a class="btn btn-success btn-sm" href="<?php echo e(URL::to('union/'.$thanaUpazila->id)); ?>" title="Create union under this Thana / Upazila "><i class="fa fa-pencil"></i>  Create </a> </td>
                                        <td class="text-dark">

            ...
            <div class="card">
                ...
                <div class="card-block">
                    <div class="j-wrapper j-wrapper-640">
                        <?php echo Form::open(['route'=>['profile.update',Auth::user()->id],'method'=>'PUT','class'=>'j-pro','id'=>'j-pro']); ?>
                            ...
                            <!-- end /.content -->
                            <div class="j-footer">
                                <a class="btn btn-warning" href="<?php echo e(URL::to('profile')); ?>"> Profile Update </a>
